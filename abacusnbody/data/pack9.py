...
def unpack_pack9(
    data, boxsize, velzspace_to_kms, float_dtype=np.float32, posout=None, velout=None
):
    ...
    npart = _unpack_pack9(
        data, boxsize, velzspace_to_kms, _posout, _velout, float_dtype
    )
