...
EXAMPLE_SUBSAMPLE_HALOS = pjoin(
    REFDIR, 'Mini_N64_L32/z0.000/halos_xcom_2_seed600_abacushod_oldfenv_MT_new.h5'
)
EXAMPLE_SUBSAMPLE_PARTS = pjoin(
    REFDIR, 'Mini_N64_L32/z0.000/particles_xcom_2_seed600_abacushod_oldfenv_MT_new.h5'
)
EXAMPLE_LRGS = pjoin(REFDIR, 'Mini_N64_L32/z0.000/galaxies_rsd/LRGs.dat')
EXAMPLE_ELGS = pjoin(REFDIR, 'Mini_N64_L32/z0.000/galaxies_rsd/ELGs.dat')
